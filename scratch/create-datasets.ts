...
const datasetDefinitions = [
  {
    ...
    description: 'Dataset repository for Boat and Stream quantitative aptitude questions.',
  },
  {
    topicCode: 'COMPOUND_INTEREST',
    conceptCode: 'COMPOUND_INTEREST',
    name: 'Compound Interest Dataset',
    description: 'Dataset repository for Compound Interest quantitative aptitude questions.',
  },
  {
    topicCode: 'CYLINDER_CSA',
    conceptCode: 'CYLINDER_CSA',
    name: 'Cylinder CSA Dataset',
    description: 'Dataset repository for Cylinder Curved Surface Area mensuration questions.',
  },
  {
    topicCode: 'PROBABILITY_BALL',
    conceptCode: 'PROBABILITY_BALL',
    name: 'Probability Ball Dataset',
    description: 'Dataset repository for Probability and ball selection questions.',
  },
  {
    topicCode: 'SALARY_RATIO',
    conceptCode: 'SALARY_RATIO',
    name: 'Salary Ratio Dataset',
    description: 'Dataset repository for Salary and Income Ratio quantitative questions.',
  },
  {
    topicCode: 'SPEED_DISTANCE_RATIO',
    conceptCode: 'SPEED_DISTANCE_RATIO',
    name: 'Speed Distance Ratio Dataset',
    description: 'Dataset repository for Speed, Distance, and Time Ratio questions.',
  },
  {
    topicCode: 'SPEED_FACTOR',
    conceptCode: 'SPEED_FACTOR',
    name: 'Speed Factor Dataset',
    description: 'Dataset repository for Speed Factor and Relative Motion questions.',
  },
];
...
async function main() {
  ...
  for (const def of datasetDefinitions) {
    ...
    if (!topic || !concept) {
      console.error(`Missing topic (${def.topicCode}) or concept (${def.conceptCode})`);
      continue;
    }
    ...
    console.log(`[DATASET CREATED] ID: ${dataset.id} | Name: "${dataset.name}" | TopicId: ${topic.id} | ConceptId: ${concept.id}`);
  }
