  ...
  const templates = [
    {
      ...
      description:
        "Standard frontend assessment focusing on HTML, CSS, JavaScript, and React components.",
    ...
    },
    {
      ...
      description:
        "Comprehensive backend assessment assessing Node.js, NestJS, database query tuning, and system architecture.",
    ...
    },
    {
      ...
      description:
        "Challenging fullstack assessment covering frontend rendering, API architecture, data persistence, and performance.",
