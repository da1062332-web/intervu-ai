...
export const FALLBACK_RULE: SkillRecommendationRule = {
  critical: [
    'Review general software engineering best practices.',
  ],
  high: [
    'Review basic programming design patterns and system analysis.',
  ],
  medium: [
    'Learn software development lifecycles and clean code strategies.',
  ],
  low: [
    'Explore advanced architectural paradigms and coding style standards.',
  ],
