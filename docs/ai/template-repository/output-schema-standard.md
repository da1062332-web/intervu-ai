...
**Objective:** Define the structure of hydrated and generated questions.  
**Version:** 1.0.0
...
export interface GeneratedQuestion {
   ...
   * For MCQ/Multiple Select, this array contains choices (min 2, typically 4).
   * For other types, it can contain options or be empty.
   */
  options: string[];
