...
*Conclusion*: The current schema does not match the architectural expectations. We cannot proceed to launch with raw JSON fields replacing relational models.
...
*Conclusion*: The migrations applied so far do not encompass the full required schema. 
...
- *However*, we cannot verify indexes/constraints for the missing models.
