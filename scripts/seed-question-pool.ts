  ...
  try {
    ...
    const conceptQuestions = [
      ...
      },
      {
        ...
        difficultyLevel: DifficultyLevel.MEDIUM,
        questionText:
          "If a price increases from $80 to $100, what is the percentage increase?",
        options: ["20%", "25%", "30%", "15%"],
        correctAnswer: "25%",
      ...
      // Aptitude
      {
        ...
        difficultyLevel: DifficultyLevel.MEDIUM,
        questionText:
          "A train running at 60 km/hr passes a pole in 9 seconds. What is the length of the train?",
        options: ["120 metres", "150 metres", "180 metres", "324 metres"],
        correctAnswer: "150 metres",
        solution:
          "Speed = 60 * (5/18) = 50/3 m/s. Length = (50/3) * 9 = 150 metres.",
      },
      {
        conceptKey: "aptitude",
        difficultyLevel: DifficultyLevel.MEDIUM,
        questionText:
          "If A can finish a work in 10 days and B in 15 days, how long will they take working together?",
      ...
      // Technical / Frontend / React
      {
        ...
        difficultyLevel: DifficultyLevel.MEDIUM,
        questionText:
          "Which hook should be used for side effects in a functional React component?",
      ...
      },
      {
        ...
        correctAnswer: "O(N^2)",
        solution:
          "Quicksort worst case complexity is O(N^2) when partitions are unbalanced.",
      },
    ];
    ...
    console.log(
      `- Seeded ${createdCount} new questions into GeneratedQuestion table.`,
    );
