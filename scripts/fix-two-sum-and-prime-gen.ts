...
async function fixTwoSumAndPrime() {
  console.log("Fixing Two Sum and Prime Number coding questions in GeneratedQuestion and TestInstanceQuestion...");
  ...
  try {
    await prisma.generatedQuestion.update({
      ...
      data: {
        questionType: "CODING",
        metadata: { codingData: primeCodingData }
      }
    });
  } catch (e) {}

  // Update in TestInstanceQuestion snapshots
  ...
  console.log("Successfully fixed Two Sum and Prime Number coding questions and snapshots.");
}
