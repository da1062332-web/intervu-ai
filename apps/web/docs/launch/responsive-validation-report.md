...
- _Issue_: Question Palette was pushing content horizontally on `320px`.
- _Fix_: Converted Execution Layout to stack on mobile (`lg:col-span-8` over `lg:col-span-4`), placing the Palette underneath the Question on small screens.
