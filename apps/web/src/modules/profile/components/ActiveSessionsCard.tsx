      ...
      <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
        <div>
          ...
          <p className='text-sm text-muted-foreground mt-1'>
            Manage and secure your account access.
          </p>
        </div>
        ...
        {sessions.length === 0 ? (
          ...
          sessions.map((session) => {
            ...
            return (
              <div
                key={session.id}
                className={`flex flex-col sm:flex-row sm:items-center gap-4 p-5 ${isCurrent ? 'bg-primary/5' : 'hover:bg-muted/20'} transition-colors`}
              >
                ...
                <div className='flex-1 min-w-0 space-y-1'>
                  ...
                  <div className='flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground'>
                    ...
                    <span className='flex items-center gap-1.5'>IP: {session.ip || 'Unknown'}</span>
