...
const BASE_TESTS: Test[] = [
  ...
  },
  {
    ...
    description: 'A comprehensive evaluation of React framework fundamentals, component lifecycle, state management, hooks, and performance tuning techniques.',
    durationMinutes: 60,
    totalQuestions: 40,
    difficulty: 'Hard',
    sections: [
  ...
  },
  {
    ...
    description: 'Evaluate your problem-solving capabilities using Python. Covers tree traversal, graph algorithms, dynamic programming, and complexity analysis.',
    durationMinutes: 120,
    totalQuestions: 3,
    difficulty: 'Hard',
    sections: [
  ...
  },
  {
    ...
    description: 'Test your understanding of JavaScript engine internals, Event Loop, prototype chain, closures, scope, async/await, and promises.',
    durationMinutes: 45,
    totalQuestions: 30,
    difficulty: 'Easy',
    sections: [
  ...
  },
  {
    ...
    description: 'Assess architectural design patterns, microservices design, caching strategies, horizontal/vertical scaling, database replication, and load balancing.',
    durationMinutes: 90,
    totalQuestions: 15,
    difficulty: 'Hard',
    sections: [
...
for (let i = BASE_TESTS.length + 1; i <= 100; i++) {
  ...
  mockTestCatalog.push({
    ...
    difficulty,
    sections: [
      { id: `sec-g-1-${i}`, name: 'Foundational Knowledge', questionCount: Math.floor(questions / 2), durationMinutes: Math.floor(duration / 2) },
      { id: `sec-g-2-${i}`, name: 'Practical Applications', questionCount: Math.ceil(questions / 2), durationMinutes: Math.ceil(duration / 2) }
    ],
    syllabus: [
