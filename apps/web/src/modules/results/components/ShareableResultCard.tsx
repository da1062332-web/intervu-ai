      ...
      <CardContent>
        <div className="flex flex-col md:flex-row gap-6 items-center justify-between bg-white p-6 rounded-lg border border-indigo-50">
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-1">Assessment</h3>
            <p className="text-lg font-bold text-gray-900">{report.assessment.title}</p>
            <p className="text-sm text-gray-500 mt-1">Completed: {new Date(report.completedAt).toLocaleDateString()}</p>
          </div>
          ...
          <div className="flex gap-8 justify-center">
            ...
            <div className="text-center">
              <div className="text-3xl font-black text-indigo-600">Top {100 - report.percentile}%</div>
        ...
        <div className="flex justify-end gap-3 mt-6">
          <Button variant="outline" className="border-indigo-200 text-indigo-700 hover:bg-indigo-50" onClick={handleCopyLink}>
