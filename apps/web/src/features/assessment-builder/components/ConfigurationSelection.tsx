...
export const ConfigurationSelection: React.FC<ConfigurationSelectionProps> = ({ onSelect, selectedId }) => {
  ...
  const availableConfigs = configs?.filter(c => c.status === 'VALIDATED' || c.status === 'PUBLISHED') || [];
