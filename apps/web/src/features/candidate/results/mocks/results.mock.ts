...
export const mockRecommendations: Recommendation[] = [
  {
    ...
    description: 'You struggled significantly with Time & Work questions. Review the foundational formulas and practice 20-30 basic problems.'
  },
  {
    id: 'rec-2',
    priority: 'HIGH',
    title: 'Practice Percentage Calculations',
    description: 'Your accuracy on percentage-based questions was lower than expected. Focus on rapid mental math for fractions to percentages.'
  },
  {
    id: 'rec-3',
    priority: 'MEDIUM',
    title: 'Refine Aptitude Speed',
    description: 'While your accuracy is good, your time-per-question on general aptitude could be improved for better overall pacing.'
  },
  {
    id: 'rec-4',
    priority: 'LOW',
    title: 'Maintain Reasoning Excellence',
    description: 'You demonstrated exceptional reasoning capabilities. Continue practicing high-difficulty logic puzzles to maintain this strength.'
  }
];
