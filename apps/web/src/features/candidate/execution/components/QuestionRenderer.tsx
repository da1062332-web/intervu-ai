...
export function QuestionRenderer() {
  ...
  return (
    <div className='flex flex-col flex-1 w-full h-full overflow-hidden bg-white select-none'>
      ...
      {/* Two-Column Split Pane for standard MCQs / MSQs */}
      <div className='flex flex-col lg:flex-row flex-1 w-full overflow-hidden divide-y lg:divide-y-0 lg:divide-x divide-gray-300 min-h-[420px]'>
        {/* Left Pane - Directions / Passage / Stem */}
        <div className='w-full lg:w-1/2 overflow-y-auto p-5 sm:p-6 bg-white shrink-0 custom-scrollbar select-text'>
        ...
        {/* Right Pane - Question Statement & Options */}
        <div className='w-full lg:w-1/2 overflow-y-auto p-5 sm:p-6 bg-white flex flex-col justify-between custom-scrollbar select-text'>
