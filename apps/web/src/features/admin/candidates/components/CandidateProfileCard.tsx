    ...
    <Card className="p-6 border-l-4 border-l-primary shadow-xs">
      <CardHeader className="p-0 mb-6 flex flex-row items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-xl font-bold text-foreground">{candidate.name || 'Unnamed Candidate'}</CardTitle>
      ...
      <CardContent className="p-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 border-t pt-6 border-border/40">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-foreground mt-0.5 break-all">{candidate.email || 'N/A'}</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm font-medium text-foreground mt-0.5">{candidate.phone || 'Not provided'}</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-semibold uppercase text-muted-foreground">Registration Date</p>
            <p className="text-sm font-medium text-foreground mt-0.5">{formatCandidateDate(candidate.createdAt)}</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-semibold uppercase text-muted-foreground">Account Standing</p>
            <div className="mt-1">
