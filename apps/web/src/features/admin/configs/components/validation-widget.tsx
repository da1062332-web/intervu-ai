    ...
    <div className={`p-4 border rounded-lg shadow-sm ${
      ...
      <div className='flex items-center justify-between'>
        <div className='text-sm font-medium'>
          Difficulty Total = <span className={isValid ? 'text-green-600 dark:text-green-400 font-bold' : 'text-red-600 dark:text-red-400 font-bold'}>
            {totalPercentage}%
          </span>
        </div>
        <div className={`text-xs px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider ${
          isValid 
