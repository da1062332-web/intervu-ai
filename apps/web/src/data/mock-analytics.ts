...
export const mockRecentActivity: ActivityData[] = [
  { id: "1", type: "interview", title: "Technical Interview Completed", description: "John Doe completed the Senior Frontend Developer interview.", timestamp: "2 hours ago" },
  { id: "2", type: "assessment", title: "New Assessment Created", description: "Backend Engineering Q3 assessment has been published.", timestamp: "5 hours ago" },
  { id: "3", type: "system", title: "Weekly Report Generated", description: "Your weekly performance report is ready.", timestamp: "1 day ago" }
];
