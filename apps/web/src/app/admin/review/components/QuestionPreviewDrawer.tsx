...
export function QuestionPreviewDrawer({
  ...
  const { setPreviewResult, setSolutionTemplate, setExplanationTemplate, reset } = useTemplatePreviewStore();
        ...
        {question ? (
          <div className="space-y-6">
            ...
            {question.instructions && (
              <div className="space-y-2">
                <h3 className="font-semibold text-sm text-gray-500 uppercase tracking-wider">Instructions</h3>
