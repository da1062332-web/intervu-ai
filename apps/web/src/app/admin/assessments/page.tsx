...
import { useActivateAssessment, useDeactivateAssessment } from '@/modules/admin-analytics/hooks/useRecentAssessments';
        ...
        <CardHeader className="p-5 border-b bg-card flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <CardDescription className="text-xs text-muted-foreground mt-1">
              Click any action icon to inspect assessment performance reports, modify test parameters, or toggle availability.
            </CardDescription>
          </div>
