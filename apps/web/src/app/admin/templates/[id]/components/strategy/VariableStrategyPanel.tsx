      ...
      >
        <div className='p-3 bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-800 rounded-md'>
          <p className='text-sm text-indigo-800 dark:text-indigo-300'>
            <strong>Variable Strategy:</strong> Each question instance is generated by resolving
            variable values, evaluating formulas, and hydrating the question template. Every
            generated question is numerically unique.
          </p>
        </div>
      </TemplateSection>
