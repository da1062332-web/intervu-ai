  ...
  const openConstraintModal = (item?: ConstraintDefinition) => {
    ...
    if (item) {
      ...
      setConstraintForm({
        ...
        value:
          item.operator === 'Formula' || item.operator === 'Custom' || item.operator === 'Regex'
        ...
        {draftedStrategy && (
          <div className='space-y-4 rounded-lg border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-white p-6 dark:border-amber-800 dark:from-amber-950/30 dark:to-transparent'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center justify-between'>
                <h4 className='text-base font-semibold'>
                  Derived Variables ({draftedStrategy.derivedVariables.length})
                </h4>
              </div>
              <div className='overflow-hidden rounded-md border'>
                <Table>
            ...
            <div className='space-y-3'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Create formula-based values that depend on base variables.
                  </p>
                </div>
                        ...
                        <TableRow key={item.id}>
                          ...
                          <TableCell className='space-x-2 text-right'>
                            <Button
                              variant='ghost'
                              size='sm'
                              onClick={() => openConstraintModal(item)}
                            >
                              <Edit2 className='h-4 w-4' />
                            </Button>
                            <Button
        ...
        <div className='w-full max-w-md space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={(event) => setVariableForm({ ...variableForm, name: event.target.value })}
            />
          </div>
          <div className='space-y-2'>
            ...
            <select
              ...
              onChange={(event) => setVariableForm({ ...variableForm, type: event.target.value })}
          ...
          <div className='space-y-2'>
            ...
            <select
              id='strategyVarGenerator'
              value={variableForm.generator}
              onChange={(event) =>
                setVariableForm({ ...variableForm, generator: event.target.value })
              }
              className='flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm dark:border-gray-800 dark:bg-gray-950'
            >
          ...
          <div className='grid grid-cols-2 gap-3'>
            <div className='space-y-2'>
              ...
              <Input
                ...
                onChange={(event) => setVariableForm({ ...variableForm, min: event.target.value })}
              />
            </div>
            <div className='space-y-2'>
              ...
              <Input
                ...
                onChange={(event) => setVariableForm({ ...variableForm, max: event.target.value })}
              />
            </div>
          </div>
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={(event) =>
                setVariableForm({ ...variableForm, defaultValue: event.target.value })
              }
            />
          </div>
        ...
        <div className='w-full max-w-md space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={(event) => setDerivedForm({ ...derivedForm, name: event.target.value })}
            />
          </div>
          <div className='space-y-2'>
            <Label htmlFor='derivedExpression'>Expression</Label>
            <Input
              id='derivedExpression'
              value={derivedForm.expression}
              onChange={(event) =>
                setDerivedForm({ ...derivedForm, expression: event.target.value })
              }
              placeholder='e.g. (selling_price - cost_price) / cost_price * 100'
            />
          </div>
          <div className='flex justify-end gap-2'>
            <Button variant='outline' onClick={() => setDerivedModalOpen(false)}>
              Cancel
            </Button>
        ...
        <div className='w-full max-w-md space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              onChange={(event) =>
                setConstraintForm({ ...constraintForm, target: event.target.value })
              }
              placeholder={
                constraintForm.operator === 'Formula' ||
                constraintForm.operator === 'Custom' ||
          ...
          <div className='space-y-2'>
            ...
            <select
              ...
              onChange={(event) =>
                setConstraintForm({ ...constraintForm, operator: event.target.value })
              }
              className='flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm dark:border-gray-800 dark:bg-gray-950'
            >
              <option value='>'>&gt;</option>
          ...
          <div className='space-y-2'>
            ...
            <Input
              ...
              value={constraintForm.value}
              onChange={(event) =>
                setConstraintForm({ ...constraintForm, value: event.target.value })
              }
              placeholder={
                constraintForm.operator === 'Regex'
                  ? '^\\d+$'
