...
export function TableSkeleton({
  ...
  return (
    <div
      className={cn(
        'border border-border/40 rounded-xl bg-card shadow-sm overflow-hidden',
        className,
      )}
    >
      <Table>
...
export function CardSkeleton({ className }: { className?: string }) {
  return (
    <Card
      className={cn(
        'overflow-hidden border border-border/40 bg-card/40 backdrop-blur-sm',
        className,
      )}
    >
...
export function PageSkeleton({
  ...
  return (
    <div
      className={cn(
        'container mx-auto py-8 px-4 sm:px-6 lg:px-8 max-w-7xl space-y-8 animate-fade-in-up pb-8',
        className,
      )}
    >
