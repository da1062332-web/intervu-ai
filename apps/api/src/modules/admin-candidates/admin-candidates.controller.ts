...
export class AdminCandidatesController {
  ...
  @ApiOperation({
    summary:
      "Retrieve full list of candidates with summary stats (unpaginated)",
  })
  @ApiQuery({
    name: "search",
    required: false,
  ...
  @ApiQuery({
    ...
    type: String,
    description:
      "Sort attribute (name, email, averageScore, bestScore, createdAt)",
  })
  @ApiQuery({
    name: "sortOrder",
    required: false,
  ...
  @Get(":id")
  @ApiOperation({
    summary: "Retrieve detailed profile information for a specific candidate",
  })
  @ApiParam({ name: "id", required: true, description: "Candidate User ID" })
  @ApiOkResponse({
    type: CandidateDetailsResponseDto,
  ...
  @Get(":id/stats")
  @ApiOperation({
    summary: "Retrieve aggregated test and evaluation metrics for a candidate",
  })
  @ApiParam({ name: "id", required: true, description: "Candidate User ID" })
  @ApiOkResponse({
    type: CandidateStatsResponseDto,
  ...
  @Get(":id/tests")
  @ApiOperation({
    summary: "Retrieve paginated test attempt history for a candidate",
  })
  @ApiParam({ name: "id", required: true, description: "Candidate User ID" })
  @ApiQuery({
    name: "page",
  ...
  @ApiOkResponse({
    type: CandidateTestHistoryResponseDto,
    description: "Candidate test history retrieved successfully",
  })
  @ApiBadRequestResponse({ description: "Invalid Request" })
  @ApiUnauthorizedResponse({ description: "Unauthorized" })
  @ApiForbiddenResponse({ description: "Forbidden - Requires ADMIN role" })
