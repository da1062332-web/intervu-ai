...
describe("AssemblyVersionService", () => {
  ...
  beforeEach(async () => {
      ...
      providers: [
        AssemblyVersionService,
        {
          ...
          useValue: {
            ...
            getVersion: jest
              .fn()
              .mockResolvedValue({ id: "v-1", snapshotData: { sections: [] } }),
        ...
        },
        {
          ...
          useValue: {
            getAssembly: jest
              .fn()
              .mockResolvedValue({ id: "test-1", sections: [] }),
    ...
    versionRepo = module.get<AssemblyVersionRepository>(
      AssemblyVersionRepository,
    );
    auditService = module.get<AssemblyAuditService>(AssemblyAuditService);
    assembledTestRepo = module.get<AssembledTestRepository>(
